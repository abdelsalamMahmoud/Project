<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="{{asset('assets/front/assets/img/me.jpg')}}" alt="..." /></span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{route('awards')}}">Awards</a></li>
        </ul>
    </div>
</nav>
